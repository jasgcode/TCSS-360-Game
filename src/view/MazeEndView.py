...
class MazeEndView:
    def __init__(self, screen, width, height):
        ...
        self.end_text = self.font.render("Unfortunate, you didnt pass your sobriety tests.", True, (0, 0, 0))
        self.button_text = self.button_font.render("Main Menu", True, (255, 255, 255))
        self.button_rect = pygame.Rect(self.width // 2 - 100, self.height // 2 + 50, 200, 50)

    def draw(self):
        self.screen.fill((240, 240, 220))  # Fill screen with black
